...
export default function ClassProgramsDirectoryPage() {
    ...
    const fetchProfileAndReports = async () => {
        ...
        try {
            ...
            console.error("Error fetching data on Lisan programs page:", err);
        ...
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 space-y-6 max-w-7xl mx-auto px-1 pb-16">
            ...
            <div className="flex items-center justify-between">
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 text-slate-700 rounded-2xl border border-slate-200 text-xs font-black uppercase tracking-wider transition-all shadow-sm"
                >
                    <ArrowLeft size={16} />
                    <span>Back to Lisan Hub</span>
                </button>
                <span className="text-[10px] font-black uppercase tracking-widest text-sky-600 bg-sky-50 px-3 py-1.5 rounded-xl border border-sky-100">
                    Lisan Directory
                </span>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-600 to-sky-500 rounded-[2rem] p-6 sm:p-8 text-white shadow-xl shadow-sky-500/10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="space-y-2">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-black tracking-tight">Class Programs & Poster Directory</h1>
