            ...
            <nav className="hidden md:flex md:items-center md:space-x-8">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-0 pt-3 w-56 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 z-50">
                  <div className="bg-white shadow-2xl py-3 border border-slate-100 rounded-xl">
                    ...
                    <a href="#" className="block px-5 py-3 text-slate-700 hover:bg-sky-50 hover:text-sky-600 font-medium text-base" onClick={() => { navigate.push('/complaints') }}>Complaints</a>
                  </div>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-0 pt-3 w-60 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 z-50">
                  <div className="bg-white shadow-2xl py-3 border border-slate-100 rounded-xl">
                    {(hasRole("class_teacher") || hasRole("super_admin") || hasRole("HOD") || hasRole("HOS") || hasRole("Principal") || hasRole("vice_principal") || hasRole("medical_teacher")) && (
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full right-0 mt-0 pt-3 w-64 opacity-0 translate-y-2 pointer-events-none group-hover:opacity-100 group-hover:translate-y-0 group-hover:pointer-events-auto transition-all duration-200 z-50">
                    <div className="bg-white shadow-2xl py-3 border border-slate-100 rounded-xl">
                      ...
                      <a href="#" className="block px-5 py-3 text-slate-700 hover:bg-sky-50 hover:text-sky-600 font-medium text-base" onClick={() => { navigate.push('/attendance-report') }}>Attendance Report</a>
                      <a href="#" className="block px-5 py-3 text-slate-700 hover:bg-sky-50 hover:text-sky-600 font-medium text-base" onClick={() => { navigate.push('/admin-complaints') }}>Attendance Complaints</a>
                      <a href="#" className="block px-5 py-3 text-slate-700 hover:bg-sky-50 hover:text-sky-600 font-medium text-base" onClick={() => { navigate.push('/report') }}>Deduction Report</a>
                      ...
                      <a href="#" className="block px-5 py-3 text-slate-700 hover:bg-sky-50 hover:text-sky-600 font-medium text-base" onClick={() => { navigate.push('/leave-docs') }}>Leave Documentation</a>
        ...
        <div className="p-6">
          ...
          <nav className="flex flex-col">
            ...
            <div className="border-t border-slate-100 first:border-t-0">
              ...
              {openDropdown === 'mb-attendance' && (
                <div className="bg-slate-50/50 pb-3">
                  ...
                  <a href="#" className="block px-8 py-3 text-lg font-medium text-slate-600 hover:text-sky-600 hover:bg-sky-100/50 transition-colors border-t border-slate-100" onClick={() => { navigate.push('/complaints'); setIsMenuOpen(false) }}>Complaints</a>
                </div>
              )}
            </div>
            ...
            <div className="border-t border-slate-100">
              <button
                className="w-full flex items-center justify-between px-4 py-5 font-bold text-slate-800 hover:bg-sky-50 transition-colors"
                onClick={() => toggleDropdown('mb-zehnuth')}
              >
                <span className="text-lg">ZEHNUTH</span>
                <svg className={`w-6 h-6 transition-transform duration-200 text-slate-400 ${openDropdown === 'mb-zehnuth' ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              ...
              <div className="border-t border-slate-100">
                ...
                {openDropdown === 'mb-admin' && (
                  <div className="bg-slate-50/50 pb-3">
                    ...
                    <a href="#" className="block px-8 py-3 text-lg font-medium text-slate-600 hover:text-sky-600 hover:bg-sky-100/50 transition-colors border-t border-slate-100" onClick={() => { navigate.push('/attendance-report'); setIsMenuOpen(false) }}>Attendance Report</a>
                    <a href="#" className="block px-8 py-3 text-lg font-medium text-slate-600 hover:text-sky-600 hover:bg-sky-100/50 transition-colors border-t border-slate-100" onClick={() => { navigate.push('/admin-complaints'); setIsMenuOpen(false) }}>Attendance Complaints</a>
                    <a href="#" className="block px-8 py-3 text-lg font-medium text-slate-600 hover:text-sky-600 hover:bg-sky-100/50 transition-colors border-t border-slate-100" onClick={() => { navigate.push('/report'); setIsMenuOpen(false) }}>Deduction Report</a>
                    ...
                    <a href="#" className="block px-8 py-3 text-lg font-medium text-slate-600 hover:text-sky-600 hover:bg-sky-100/50 transition-colors border-t border-slate-100" onClick={() => { navigate.push('/leave-docs'); setIsMenuOpen(false) }}>Leave Documentation</a>
